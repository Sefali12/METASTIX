      ...
      <div className="pt-24 sm:pt-32 pb-8 sm:pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/50 max-w-xl mx-auto leading-relaxed text-sm sm:text-base px-2">
            Upload a proof file to verify that a feedback message was submitted to the blockchain.
            This confirms the message existed at the claimed time.
          </p>
        </div>
      </div>
